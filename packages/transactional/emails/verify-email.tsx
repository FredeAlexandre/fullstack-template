...
const VerifyEmail = ({ userFirstname, verificationLink }: VerifyEmailProps) => {
	return (
		<Html>
			<Head />
			...
			<Body style={main}>
				<Container style={container}>
					...
					<Section>
						...
						<Text style={text}>
							Thank you for signing up with Acme! To complete your registration,
						...
						<Text style={text}>
							Need help? Visit our{" "}
							<Link style={anchor} href="https://acme.com/help">
								Help Center
							</Link>{" "}
